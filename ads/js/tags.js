...
function expo9_ad() {
  ...
  t.displayAdURL = t.host+"/displayAd.js?dver=" + displayAdVersion + "&th=" + t.tagHash;
}
...
expo9_ad.prototype.showAd = function () {
  ...
  t.url = t.host+"/" + t.cmd + t.uparams + t.params + "&rnd=" + rnd;
...
function drawTags(t) {
  if (t.tagType == "iframe") {
     ...
     var hrefURL = t.host+"/i.click" + t.uparams + t.params;
